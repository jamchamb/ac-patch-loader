...
clean:
	@echo clean ...
	@rm -fr $(BUILD) $(OUTPUT).elf $(OUTPUT).dol $(OUTPUT).patch
#---------------------------------------------------------------------------------
run:	
...
# patchfile: patch-test.dol
# 	dd if=patch-test.dol of=patchfile skip=8448 bs=1

#---------------------------------------------------------------------------------
# main targets
#---------------------------------------------------------------------------------
$(OUTPUT).patch: $(OUTPUT).dol
